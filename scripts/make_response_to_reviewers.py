...
response('We have added this explanation (Multivariate Analysis). The modest R² '
         ...
         'ceiling; a companion structural analysis that adds hydrogen-bond and '
         'electrostatic descriptors reaches only a leave-one-protein-out rank '
         'correlation of ≈ 0.44. Our models are best read as identifying which static '
...
response('We appreciate this suggestion and now address it directly. The variables '
         ...
         'note that a companion structural study which does add hydrogen-bond and '
         'electrostatic descriptors improves the leave-one-protein-out rank correlation '
         'only to ≈ 0.44, confirming that much of the quantum-yield variance reflects '

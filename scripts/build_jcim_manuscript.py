...
add_body(
    ...
    'circular. At the single-structure level (Figure 1), emission '
    'wavelength correlated with eccentricity '
    '(Figure 1B; \u03c1 = +0.320, p = 1.4 \u00d7 10\u207b\u00b9\u2076), minor axis '
    '(Figure 1A; \u03c1 = \u20130.329, p = 1.9 \u00d7 10\u207b\u00b9\u2077), and '
    'circularity (Figure 1C; \u03c1 = \u20130.258, p = 4.5 \u00d7 10\u207b\u00b9\u00b9). '
    'Emission was weakly correlated with the major axis (Figure 1D; '
    '\u03c1 = +0.176, p = 8.3 \u00d7 10\u207b\u2076) and uncorrelated with barrel length '
    '(\u03c1 = \u20130.028, p = 0.47). '
...
add_body(
    ...
    '(Figure 2A; \u03c1 = \u20130.309, p = 2.7 \u00d7 10\u207b\u2078, n = 310), surviving partial correlation '
    ...
    'rigid than the barrel. The two color classes differ, at matched '
    'resolution (mean 1.86 vs 1.84 Å), in which partner is better ordered: '
    'in green FPs the compact, deeply buried HBI chromophore is more ordered '
    'than its barrel (ratio 0.76; absolute chromophore B 22.6 vs barrel '
    '28.6 Å²), whereas in red FPs the chromophore’s own absolute B-factor '
    'is higher (27.7 Å²) and essentially matches its barrel (26.8 Å²; '
    'ratio 1.02). This elevated mobility is distributed uniformly across the '
    'red chromophore rather than localized to its larger acylimine '
    'extension: in the 64 acylimine-type (NRQ, CRQ) red chromophores, the '
    'per-atom B-factors of the acylimine backbone, the residue-1 side chain, '
    'and the conjugated core are statistically indistinguishable (each '
    '≈ 1.15 times the barrel Cα value). The whole red chromophore, not a '
    'flexible peripheral group, is thus held less rigidly relative to its '
    'barrel than the smaller green HBI; as this is a crystallographic '
    'ordering measure, we do not infer a specific dynamical cause.'
)
...
add_body(
    ...
    'B-factor ratio (Figure 2B; \u03c1 = +0.423), the B-factor ratio carries '
...
add_body(
    ...
    'https://github.com/headsparkle/gfp-barrel-geometry. The complete '
...
add_body(
    ...
    'where available, falling back to PDB id otherwise (n = 216; 208 '
    'chromophore-positive, 8 chromophore-absent). The "Original" columns '
    ...
    'flags whether each finding remained significant at p < 0.05; ten '
    'of twelve survive. The two that do not survive are the '
    ''
    'eccentricity and '
    'minor-axis Mann–Whitney tests of chromophore-present vs '
    'chromophore-absent barrels, reflecting the small number of unique '
    'chromophore-absent proteins (n = 8) (provided as a CSV file).'
)
...
add_figure('figS1_chromophore_effect.png',
    ...
    '(n = 742, blue) and without (n = 38, orange) a validated mature '
    ...
    'structures at the structure level (p < 10⁻⁷ for both); the minor-axis '
    'difference does not survive pseudoreplication collapse to one '
    ...
    '(n = 8) and the unbalanced group sizes. See main-text Chromophore '

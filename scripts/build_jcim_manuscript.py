...
add_body(
    ...
    'of emission (\u03c1 = \u20130.311, p = 1.0 \u00d7 10\u207b\u00b9\u00b2; Figure S7C), while the '
    'summed absolute twist |\u03c4| + |\u03c6| was the single strongest geometric '
    'predictor of quantum yield across the cohort (\u03c1 = \u20130.374, '
    'p = 9.9 \u00d7 10\u207b\u00b9\u2070), exceeding the B-factor ratio. '

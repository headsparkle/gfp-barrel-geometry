...
abs_text = (
    ...
    'p = 1.9 \u00d7 10\u207b\u00b9\u2077). Chromophore dihedral twist is the '
    'strongest predictor of quantum yield (|\u03c4|+|\u03c6|: \u03c1 = \u20130.374, '
    'p = 9.9 \u00d7 10\u207b\u00b9\u2070), with the chromophore-to-scaffold B-factor '
    'ratio a secondary correlate (\u03c1 = \u20130.309, p = 2.7 \u00d7 10\u207b\u2078). '
    'Chromophore dihedral angles correlate with both barrel eccentricity '
    'and photophysical performance. Principal correlations survive '
...
add_body(
    ...
    'wavelength varies with barrel shape, that chromophore dihedral '
    'twist is the strongest predictor of quantum yield (\u03c1 = \u20130.374) '
    'with chromophore rigidity relative to the barrel a secondary '
    'correlate (\u03c1 = \u20130.309), and that dihedral twist also correlates '
    'with barrel eccentricity.'
)
...
add_body(
    ...
    'proteins): minor axis \u03c1 = \u20130.54, p = 1.6 \u00d7 10\u207b\u2076; '
    'eccentricity \u03c1 = +0.49, p = 1.3 \u00d7 10\u207b\u2075; circularity '
    '\u03c1 = \u20130.43, p = 2.0 \u00d7 10\u207b\u2074 (Table S2), ruling out '
...
add_body(
    ...
    'significant predictor of quantum yield '
    '(\u03c1 = \u20130.309, p = 2.7 \u00d7 10\u207b\u2078, n = 310), though a weaker predictor '
    'than chromophore dihedral twist (see Chromophore Dihedral Geometry, below). '
    'This correlation survived partial correlation controlling for '
    'resolution (partial \u03c1 = \u20130.282). After collapse to one highest-'
    'resolution structure per unique FPbase protein, the effect '
    'persists and remains significant (\u03c1 = \u20130.32, p = 0.046, n = 40; '
    'Table S2), indicating it is not an artifact of replicate '
    'structures. The ratio varied by color '
...
add_body(
    ...
    '\u03c1 = +0.167; |\u03c6|: \u03c1 = +0.197), quantum yield '
    '(|\u03c4|: \u03c1 = \u20130.289, p = 3.3 \u00d7 10\u207b\u2076; '
    '|\u03c6|: \u03c1 = \u20130.299, p = 1.4 \u00d7 10\u207b\u2076), and B-factor ratio '
    '(|\u03c4|: \u03c1 = +0.158; |\u03c6|: \u03c1 = +0.155). The '
    'sum \u03c4 + \u03c6 was the strongest dihedral predictor '
    'of emission (\u03c1 = \u20130.311, p = 1.0 \u00d7 10\u207b\u00b9\u00b2) and was also the '
    'single strongest geometric predictor of quantum yield across the '
    'cohort (\u03c1 = \u20130.374, p = 9.9 \u00d7 10\u207b\u00b9\u2070), exceeding the B-factor '
    'ratio. '
...
add_body(
    ...
    'and |\u03c4| yielded R\u00b2 = 0.18 (n = 250). Standardized regression '
    'coefficients show that chromophore dihedral twist |\u03c4| '
    '(\u03b2 = \u20130.242, p = 1.1 \u00d7 10\u207b\u2074) and the B-factor ratio '
    '(\u03b2 = \u20130.225, p = 6.4 \u00d7 10\u207b\u2074) are the two independently '
    'significant geometric predictors, with twist the larger '
    'contributor; eccentricity (\u03b2 = +0.010, p = 0.90) and minor axis '
    '(\u03b2 = +0.107, p = 0.21) were not significant after controlling for '
    ...
    'chromophore twist and rigidity rather than barrel shape per se.'
)
...
add_body(
    ...
    'quantum yield achieved out-of-bag R\u00b2 = 0.19, with the B-factor '
    'ratio and chromophore dihedral twist |\u03c4| as the two dominant '
    'features (comparable permutation importances, \u2248 0.49 each). '
    'The model\u2019s modest performance indicates that barrel and '
    'chromophore geometry constrain but do not fully determine '
    'quantum yield.'
)
...
add_body(
    ...
    'and orange \u2264 11), the 780 entries are not fully independent (633 '
    'spectrally matched entries correspond to only 70 unique FPbase '
    'names), and the PDB itself is not a random sample of all FPs \u2014 '
    'heavily studied variants such as GFP and mCherry are overrepresented '
    'while many natural and engineered FPs have no deposited structure. '
    'These pseudoreplication and selection issues are partially addressed '
    'by the unique-protein collapse (Table S2), which preserves the '
    'principal correlations, but the generalizability to FPs outside the '
    'crystallized subset remains to be established. Crystal-lattice '
...
add_body(
    ...
    'uninformative. Chromophore dihedral twist is the strongest single '
    'predictor of quantum yield (|τ|+|φ|: ρ = –0.374), with the '
    'chromophore-to-barrel B-factor ratio a secondary but independent '
    'correlate (ρ = –0.309, partial ρ = –0.282 controlling for '
    'resolution); multivariate analysis indicates that these two '
    'factors, rather than barrel shape per se, account for the '
    'bivariate correlations between barrel geometry and '

...
abs_text = (
    ...
    '(chromophore-to-barrel B-factor ratio, \u03c1 = \u20130.51 per unique FP), '
...
add_body(
    ...
    '(chromophore-to-barrel B-factor ratio, \u03c1 = \u20130.51 per unique FP) and on '
...
add_body(
    ...
    '(\u03c1 = \u20130.51, n = 77; Table S6), comparable to chromophore ground-state '
...
add_body(
    ...
    '(ρ = –0.51 per unique FP), with the chromophore’s own ground-state '
...
add_body(
    ...
    'crystals collapsed to one entry per protein by median (n = 77 unique FPs '
    ...
    'B-factor ratio (ρ = –0.51) each survive adjustment for the other '
    '(partial ρ = –0.35 and –0.46), confirming two distinct, independent '

...
add_body(
    ...
    'The default chain-selection rule analysed the longest '
    ...
    'nanobody fragment), and the binder was therefore analysed in place '
    ...
    'reflecting the cpFP topology). Both are well-characterised '
...
add_body(
    ...
    'at high resolution\u201d was a solvent-modelling artefact rather than '
    ...
    'and a fitted area far above its cohort neighbours. Restricting the '
    'slice to protein heavy atoms (standard amino-acid residues plus the '
    'chromophore residue) eliminated the artefact: mean area dropped from '
    ...
    'LLM-generated pipeline can be entirely an artefact of an unstated '
